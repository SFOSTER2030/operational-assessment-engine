...
export const legalModule: IndustryModule = {
   id: 'legal',
   name: 'Legal Practice Assessment',
   description: 'Assessment module for law firms and legal practices deploying client intake agents and compliance monitoring',
   ...
   complianceRequirements: [
    ...
    },
    {
           ...
           description: 'Attorney-client privilege considerations — AI-generated communications in legal matters may be discoverable',
